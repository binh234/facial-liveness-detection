...
#    model.add(Dense(128, kernel_regularizer=l2(0.0005), activation='relu', kernel_initializer=initialize_weights))
    model.add(Dense(2304, kernel_regularizer=l2(0.0005),
              activation='relu', kernel_initializer=initialize_weights))
    model.add(Dropout(0.5))
    model.add(Dense(240, kernel_regularizer=l2(0.0005),
              activation='relu', kernel_initializer=initialize_weights))
